...
const additionalFooter = <Section className="additional-footer" style={additionalFooterStyle} />;
  ...
  <>
    ...
    <Section style={contentStyle}>
      <Text className="title" style={titleStyle}>
        {name.toUpperCase()} IS LOOKING
        <br />
        FOR HELP
      </Text>
      <Text className="message" style={messageStyle}>
        "{message}"
      </Text>
      <Text className="name" style={nameStyle}>
        {name},
      </Text>
      <Text className="email" style={emailStyle}>
        {email}
      </Text>
      <Section style={dividerStyle} />
      <Text className="date" style={dateStyle}>
        {date}
      </Text>
      <Section>
