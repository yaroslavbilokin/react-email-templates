    ...
    <>
      ...
      <Container style={{ marginBottom: '60px' }}>
        <Row className="additional-footer-row" style={additionalFooterRowStyle}>
          ...
          <Column>
            <Text style={additionalFooterTextStyle}>Easy 30-Day returns & exchanges accepted</Text>
          </Column>
        </Row>
        <Row className="additional-footer-row" style={additionalFooterRowStyle}>
          <Column style={markIconStyle}>
          ...
          <Column>
            <Text style={additionalFooterTextStyle}>Shipping calculated at checkout.</Text>
          </Column>
        </Row>
        <Row className="additional-footer-row" style={additionalFooterRowStyle}>
          <Column style={markIconStyle}>
    ...
    <>
      ...
      <Section style={contentStyle}>
        ...
        <Text className="shop-description" style={shopDescriptionStyle}>
          Hey! We're excited to announce that the official <b>{shopName}</b> is now open! Get ready
          to grab your exclusive team gear, available for a limited time only.
        </Text>
