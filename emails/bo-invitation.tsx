...
export const BoInvitation = () => {
  ...
  return (
    <Html>
      ...
      <Preview>You have been invited to submit the report</Preview>
      <Body style={main}>
          ...
          <Section>
            ...
            <Section style={mainContent} className="main-content">
              <Text style={paragraph}>
                ...
                has invited you to submit your data as a Beneficial Owner.
              </Text>

              <Text style={paragraph}>Please proceed to provide your personal data.</Text>
            </Section>
